...
Up to this point, we have only talked about regression models with a single predictor (Exception: the end of [Problem Set 6](ps6.html) had an example of multiple regression).
