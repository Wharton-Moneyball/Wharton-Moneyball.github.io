...
Plotly in R is one way to begin to make your graphics interactive. Once you have your graph saved as a new object, install the plotly package and run the functin (ggplotly) on the graph in order to add interactive elements.
