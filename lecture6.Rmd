...
We again load the data (if you don't have it, download [here](data/batting_2014_2015.RData)) and use the `spread` function to separate the 2014 and 2015 batting averages into separate columns. 
