...
```{r multiline-syntax, include=FALSE}
nba_shooting_small <-
...
While it seems a bit cumbersome to write our code like this now, it will make our code much easier to read when we start to string multiple manipulations together using the pipe operator `%>%`, which we will meet in [Lecture 2](lecture2.html). 
