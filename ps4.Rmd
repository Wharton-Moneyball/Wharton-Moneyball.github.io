...
```
2. Try to make some visualizations with ggplot that explore the data. For example, plotting batting time through the order versus their event wOBA for the pitch. If you are working with the TTO data, try exploring something other than the examples for your problem set. 
