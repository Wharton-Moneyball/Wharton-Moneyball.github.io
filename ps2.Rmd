...
13. Explore the distribution of the ratings for the statistics introduced in Problem 9 using bar plots. Hint: You may need to use `factor(BBP_rating, levels = c(Awful, Poor...))` to ensure the ratings are plotted in the correct order.
