...
In this problem set, we will gain more experience using the dplyr verbs we learned in Lecture 2 to analyze batting statistics of MLB players with at least 502.2 plate appearances. All of the data is contained in the file "data/hitting_qualified.csv". You should write save all of the code for this analyses in an R script called "ps2_mlb_batting.R".
