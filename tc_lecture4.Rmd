...
When we previously ran the following code, we got a plot that's very similar to the desired one but that is missing the red line showing the average ERA within each season. 
```{r, eval = FALSE}
ggplot(pitching) +
