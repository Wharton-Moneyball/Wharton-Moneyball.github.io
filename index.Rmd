...
Welcome to the webpage for the 2021 Wharton Moneyball Academy / Training Camp course on data analysis in R.
...
Afternoon's are devoted to the programming component of the camp. Each day, the instructors will be spend the first hour or so of each class introducing new R functionality and programming concepts.
...
After the first hour of lecturing, you will have a chance to work on problem sets with your project team and UTA that will review and reinforce the material presented in that day's lecture.
...
Ryan Gross is a third year PhD student in the Statistics Department at Wharton, interested in Bayesian statistics and sports analytics. Prior to Penn, he graduated from Rutgers University Honors College with a double major in Math and Statistics and minor in Economics, where he also ran cross country and track. Growing up in New Jersey, Ryan is a diehard fan of the New York Jets, Knicks, and Yankees, along with Rutgers football and basketball. 

Eric Eager is the Vice President of Research and Development at Pro Football Focus (PFF), a worldwide leader in data analysis for American football. In his role at PFF, Eric builds and uses mathematical models to help team and media clients, along with consumers, better understand the game of football. He is the co-host of the PFF Forecast, a twice-weekly podcast living on the interface between football, math and media. 
Prior to joining PFF, Eric was a professor of mathematics at the University of Wisconsin - La Crosse, where he conducted research in applied mathematics, mathematical biology, mathematical sociology and the scholarship of teaching and learning, authoring over 20 papers and receiving two National Science Foundation grants from 2012 to 2018.  
Football has always been a big part of Eric's life, and playing sports in general was a big driver in his interest in mathematics. Prior to earning a PhD in mathematical biology in 2012, he played tight end for Minnesota State - Moorhead from 2004-2008, earning Academic All-American honors from ESPN.
