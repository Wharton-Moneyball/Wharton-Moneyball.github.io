...
Instructions for installing R and RStudio, as well as setting up your computer for the class are covered in [Lecture 0](all_lecture0.html).
...
After completing Lecture 0, [Problem Set 0](all_ps0.html) contains a brief introduction to the R programming language with some simple exercises, and several questions that will motivate the concepts you'll be exploring in the morning lectures.
...
Alex Tolbert is a 3rd-year Ph.D. student in Philosophy at the University of Pennsylvania, with a dual Master's degree in Statistics. Previously, he earned Master's in Philosophy and in Biochemistry from Virginia Tech.  He studies machine learning, causal inference, algorithmic fairness, computational social science and economics, and algorithmic game theory, with the goal of using social and political philosophy to embed social values such as fairness in the design of algorithms and models.
