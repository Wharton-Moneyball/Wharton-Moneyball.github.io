...
To make the above discussion much more concrete, let's go back to the dataset we created in the challenge question at the end of [Problem Set 3](ps3.html). Each line of this tbl is a "player-season". Printing out the tbl, we see that there is a separate row for each "player-season".
